...
return [
    ...
    */
    ...
    'exists' => 'Запись для поля :attribute не существует в БД.',
    ...
    */
    ...
    'custom' => [
        'email' => [
            'unique' => 'Эта почта уже занята',
            'exists' => 'Почта не зарегистрирована',
        ],
        'phone' => [
            'unique' => 'Этот номер телефона уже занят',
            'exists' => 'Номер телефона не найден',
        ],
        'product_color_id' => [
          'selected' => 'Цвет продукта не выбран',
        ],
        'product_color_size_id' => [
            'selected' => 'Размер цвета продукта не выбран',
        ],
        'bonus_subtract' => [
            'limit' => 'Превышен лимит бонусов для использования'
        ]
    ],
